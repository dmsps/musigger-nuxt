    ...
    <div id="home">
        ...
        <div class="grid-container">
            ...
            <template v-if="ShowTop">
                ...
                <Top :weeks="1" :count="6" :per-line="6" />

                <div class="head">
                    <h2 class="head-title">Hyped /month</h2>
                </div>
                <Top :weeks="4" :count="12" :perline="12" />
                <div class="head">
            ...
            <div class="releases grid-x">
                ...
                >
                    <router-link
                        :to="{ name: 'release-id', params: { id: Release.Id } }"
                        class="release-item grid-x"
                    >
                        <img
                            class="release-cover cell"
                            v-lazy="FilesUrl + Release.MiniCover"
                            :alt="Release.Name"
                        />
...
import { RELEASE_LIST_REQUEST } from "@/utils/actions/release"
...
export default {
    ...
    created() {
        ...
        // Helpers.setMetaImage(
        //     "http://www.musigger.com/img/icons/android-chrome-512x512.png",
        //     "twitter"
        // )
        ...
        this.ReleasesPerPage = this.$route.query.perPage
    ...
    methods: {
        getAllReleases(
            ...
            this.switchLoading()
            this.$store
                .dispatch("Release/" + RELEASE_LIST_REQUEST, options)
                .then(() => {
