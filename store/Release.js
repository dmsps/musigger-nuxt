...
const actions = {
    [RELEASE_LIST_REQUEST]({ commit }, params) {
            ...
            this.$axios
                ...
                .then(response => {
                    ...
                    if (response && response.data && response.status === 200) {
                        ...
                        Helpers.notify("error", "Error retrieving data from backend")
                    }
                })
                .catch(error => {
                    reject(error)
    ...
    [TOP_LIST_REQUEST]({ commit }, payload) {
        return new Promise((resolve, reject) => {
