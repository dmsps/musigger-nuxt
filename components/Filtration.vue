...
import { GENRE_LIST_REQUEST, LABEL_LIST_REQUEST } from "@/utils/actions/music"
...
export default {
    ...
    methods: {
        ...
        filter() {
            ...
            this.TypesQuery = this.TypesSelected != null ? this.TypesSelected.join() : null
            this.LabelsQuery = this.LabelsSelected != null ? this.LabelsSelected.join() : null
            this.GenresQuery = this.GenresSelected != null ? this.GenresSelected.join() : null
            this.$emit(
                "filter-changed",
                this.CurrentPage,
                this.Votes,
        ...
        searchChangeFocus() {
            if (this.SearchBar.Focused) {
                ...
                this.SearchBar.Placeholder =
                    "Enter the name of the artist/release or click the button on the right and just say it"
            }
        },
